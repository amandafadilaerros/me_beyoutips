...
<div class="row no-gutters mt-5">
  ...
  <div class="col-md-10 p-5">
    <h3><i class="far fa-list-alt"></i> LAPORAN PENJUALAN</h3><hr>
...
?>
    <tr>
    <td><?php echo $no++;?></td>
        <td><?php echo "<center><img src='../produk/$data[gambar]' width='150' height='150' />";?><br><?php echo $data['nama'];?></center></td>
        <td><?php echo $data['jumbel'];?></td>
        <td><?php echo $data['pembeli']; $data['email'];?></td>
        ...
        <?php
          ...
          if (isset($_POST['plh'])) {
              $update = mysqli_query($koneksi, "UPDATE tb_beli SET
								...
								");
								if ($update) {
									echo '<script>alert("Berhasil Di ACC")</script>';
									echo '<script>window.location="dataorder.php"</script>';
								}
								else {
